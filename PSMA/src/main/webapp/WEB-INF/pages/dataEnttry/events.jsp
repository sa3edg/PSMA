	...
	<tiles:putAttribute name="body">
        ...
        <table>
            ...
            <tr>
				...
				<sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_DATAENTRY')">
        	    <a href="<c:url value="addEventForm" />"><spring:message
						code="psma.addEvent" /></a></br>
                </sec:authorize>
			</div>
